...
export default function SmoothTab({
    ...
    return (
        <div className="flex flex-col h-full">
                    ...
                    {items.map((item) => {
                        ...
                        return (
                            <motion.button
                                ...
                                className={cn(
                                    "relative flex items-center justify-center gap-0.5 rounded-xl px-2 py-1.5",
            ...
            {/* Card Content Area */}
            <div className="flex-1 mb-4 relative py-1">
                <div className="bg-card border rounded-xl min-h-[800px] w-full relative">
